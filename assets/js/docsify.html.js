! function() {
    ...
    function C(e, t) {
        ...
        return e.forEach(function(e) {
            n += '<li><a class="section-link" href="' + e.slug + '">' + e.title + "</a></li>", e.children && (n += C(e.children, t))
        }), t.replace("{inner}", n)
    }
    ...
    var ne = {
        ...
        re = function(t, n) {
            this.config = t, this.router = n, this.cacheTree = {}, this.toc = [], this.linkTarget = t.externalLinkTarget || "", this.contentBase = n.getBasePath();
    ...
    function oe(e, t, n, r) {
        ...
        }), r && (d.title = i ? i.title || i.innerText + " - " + ie : ie), i
    }
    var se = function() {
        function e(e, t) {
    ...
    window.Docsify = {
            ...
            get: P,
            slugify: U
        }, window.DocsifyCompiler = re, window.marked = R, window.Prism = q, Me.version = "4.7.1",
        function(e) {

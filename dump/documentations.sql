...
-- Dumping structure for table .sys_menu
...
-- Dumping data for table .sys_menu: ~5 rows (approximately)
...
-- Dumping structure for table .sys_modules
...
-- Dumping data for table .sys_modules: ~6 rows (approximately)
...
-- Dumping structure for table .sys_privileges
...
-- Dumping data for table .sys_privileges: ~2 rows (approximately)
...
-- Dumping structure for table .sys_users
...
-- Dumping data for table .sys_users: 12 rows
...
INSERT INTO `sys_users` (`su_id`, `su_privilegeid`, `su_email`, `su_passwd`, `su_fullname`, `su_avatar`, `su_sex`, `su_dob`, `su_job_title`, `su_company`, `su_active`, `su_created_date`, `su_created_by`) VALUES
	(2, 4, 'admin@admin.com', '81dc9bdb52d04dc20036dbd8313ed055', 'Administrator', NULL, NULL, NULL, NULL, NULL, 1, '2017-10-26 01:24:33', 'system');

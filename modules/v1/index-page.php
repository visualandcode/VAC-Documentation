...
<body>
  ...
  <script>
    window.$docsify = {
      name: 'WS Framework Documentation v1',
      search: 'auto', // default
      ...
      plugins: [
        function (hook, vm) {
          hook.beforeEach(function (html) {
            url = '/md-editor/?modules/v1/' + vm.route.file
            ...
            return editHtml
              + html
              + '\n\n----\n\n'
              + '<a href="http://kct.co.id" target="_blank" style="color: inherit; font-weight: normal; \text-decoration: none;">Powered by PT Kreasndo Cipta Teknologi</a>'
          })
        }
      ]
    }
